...
##
## Read an integer, convert it to a float.
## Then find the approximate square root.
##
...
# li.s (load immediate single) is an undocumented macro (as is li.d - for a double)
#  - it is supported by QTSpim but not in the cheat sheet or the text
...
loop:	mov.s	$f6, $f0	# x' = n
	...
	nop
done:	mov.s	$f12, $f4	# print the result
	li	$v0, 2
	syscall
